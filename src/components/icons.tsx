...
/** VRChat logo (Official Brand Kit / SimpleIcons) */
export function IconVRChat({ size, className, ...props }: IconProps) {
  return (
    <Icon size={size} className={className} viewBox="0 0 512 512" {...props}>
      <path d="M495.3 128H16.7C7.5 128 0 135.5 0 144.7V331.3C0 340.5 7.5 348 16.7 348H354.3L401.7 413.5C405.3 418.5 411.3 421 417.3 421C420.7 421 424.1 420 427.3 418.1C435.6 413.2 440.7 404.3 440.7 394.7V348H495.3C504.5 348 512 340.5 512 331.3V144.7C512 135.5 504.5 128 495.3 128ZM127.3 282H73.4L45.4 195.4H74.3L91 251.6C92.5 256.7 93.8 261.3 94.8 265.5H95.3C96.3 261.3 97.6 256.7 99.1 251.6L115.8 195.4H144.7L116.7 282H127.3V282ZM241.2 282H210.3L189.5 240.5C187.3 236 185.3 231.6 183.4 227.1H182.9C183.4 232.1 183.7 236.7 183.7 241V282H156.4V195.4H187.7L207.2 235.1C209.7 240.2 211.8 244.7 213.6 248.8H214.1C213.5 244.3 213.2 239.5 213.2 234.3V195.4H241.2V282ZM328.7 231.3C328.7 242.3 325 251.4 317.5 258.6C310.1 265.8 299.7 269.4 286.3 269.4H274.3V282H247.4V195.4H286.3C299.6 195.4 309.8 198.8 317.1 205.6C324.4 212.4 328.1 220.9 328.1 231.1V231.3ZM301.2 231.2C301.2 227.3 299.9 224.2 297.2 222.1C294.6 220 290.7 218.9 285.6 218.9H274.3V245.8H285.6C296 245.8 301.2 240.9 301.2 231.2V231.2ZM428.8 269.4C428.8 273.7 427.7 277 425.4 279.1C423.1 281.2 419.7 282.2 415.2 282.2H353.7V195.4H415.2C419.7 195.4 423.1 196.4 425.4 198.5C427.7 200.6 428.8 203.9 428.8 208.2V208.4C428.8 212.7 427.7 216 425.4 218.1C423.1 220.2 419.7 221.2 415.2 221.2H380.6V231.1H415.2C419.7 231.1 423.1 232.1 425.4 234.2C427.7 236.3 428.8 239.6 428.8 243.9V244.1C428.8 248.4 427.7 251.7 425.4 253.8C423.1 255.9 419.7 256.9 415.2 256.9H380.6V269.4H415.2C419.7 269.4 423.1 270.4 425.4 272.5C427.7 274.6 428.8 277.9 428.8 282.2V282.2V269.4Z" />
    </Icon>
  );
}
