...
export function IconGift({ size, className, ...props }: IconProps) {
  return (
    <Icon size={size} className={className} viewBox="0 0 512 512" {...props}>
      <path d="M190.5 68.8L225.3 128H224 152c-22.1 0-40-17.9-40-40s17.9-40 40-40h2.2c14.9 0 28.8 7.9 36.3 20.8zM288 128h-1.3l34.8-59.2C329 55.9 342.9 48 357.8 48H360c22.1 0 40 17.9 40 40s-17.9 40-40 40H288zM0 176V384c0 35.3 28.7 64 64 64H224V256H0V176zm0-48H224V80H64C28.7 80 0 108.7 0 144v0 0-16zm288 48V448H448c35.3 0 64-28.7 64-64V176H288zm224-48c0-35.3-28.7-64-64-64H288v48H512z" />
    </Icon>
  );
}
