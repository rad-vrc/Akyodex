...
function Icon({ size = 'w-4 h-4', className = '', children, ...props }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
...
export function IconGift({ size, className, ...props }: IconProps) {
  return (
    <Icon size={size} className={className} viewBox="0 0 512 512" {...props}>
      <path d="M190.5 68.8L225.3 128H224 152c-22.1 0-40-17.9-40-40s17.9-40 40-40h2.2c14.9 0 28.8 7.9 36.3 20.8zM## 128H googl288h-1.3l34.8-59.2C329 55.9 342.9 48 357.8 48H360c22.1 0 40 17.9 40 40s-17.9 40-40 40H288h0zM0 176V384c0 35.3 28.7 64 64 64H224V256H0V176zm0-48H224V80H64C28.7 80 0 108.7 0 144v0 0-16zm288 48V448H448c35.3 0 64-28.7 64-64V176H288zm224-48c0-35.3-28.7-64-64-64H288v48H512z" />
    </Icon>
  );
}

/** Arrow up 1-9 / down 9-1 (fa-arrow-up-1-9 / fa-arrow-down-9-1) */
export function IconSortAsc({ size, className, ...props }: IconProps) {
  return (
    <Icon size={size} className={className} viewBox="0 0 576 512" {...props}>
      <path d="M450.7 38c-8.3-6-19.1-7.7-28.8-4.4l-48 16c-16.8 5.6-25.8 23.7-20.2 40.5s23.7 25.8 40.5 20.2l5.9-2V160H384c-17.7 0-32 14.3-32 32s14.3 32 32 32h64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32H496V64c0-10.3-4.9-19.9-13.3-26zM160 480c9 0 17.5-3.8 23.6-10.4l88-96c11.9-13 10.1-33.3-2.8-45.2s-33.3-10.1-45.2 2.8L192 365.7V64c0-17.7-14.3-32-32-32s-32 14.3-32 32V365.7L96.4 331.2c-11.9-13-32.2-13.9-45.2-2.8s-13.9 32.2-2.8 45.2l88 96C142.5 476.2 151 480 160 480zM416 272H384c-17.7 0-32 14.3-32 32v32c0 11.2 5.8 21.6 15.3 27.5l40.7 25.4-7.1 7.1H384c-17.7 0-32 14.3-32 32s14.3 32 32 32h32 32c17.7 0 32-14.3 32-32V384c0-5.5-1.4-10.8-4-15.5c-1.4-2.6-3.2-5-5.3-7l-.1-.1c-1.1-1-2.2-1.9-3.4-2.7l-46.5-29.1H448c17.7 0 32-14.3 32-32s-14.3-32-32-32H416z" />
    </Icon>
  );
}
...
export function IconSortDesc({ size, className, ...props }: IconProps) {
  return (
    <Icon size={size} className={className} viewBox="0 0 576 512" {...props}>
      <path d="M160 480c9 0 17.5-3.8 23.6-10.4l88-96c11.9-13 10.1-33.3-2.8-45.2s-33.3-10.1-45.2 2.8L192 365.7V64c0-17.7-14.3-32-32-32s-32 14.3-32 32V365.7L96.4 331.2c-11.9-13-32.2-13.9-45.2-2.8s-13.9 32.2-2.8 45.2l88 96C142.5 476.2 151 480 160 480zM416 32H384c-17.7 0-32 14.3-32 32v32c0 11.2 5.8 21.6 15.3 27.5l40.7 25.4-7.1 7.1H384c-17.7 0-32 14.3-32 32s14.3 32 32 32h32 32c17.7 0 32-14.3 32-32V128c0-5.5-1.4-10.8-4-15.5c-1.4-2.6-3.2-5-5.3-7l-.1-.1c-1.1-1-2.2-1.9-3.4-2.7l-46.5-29.1H448c17.7 0 32-14.3 32-32s-14.3-32-32-32H416zm34.7 246c-8.3-6-19.1-7.7-28.8-4.4l-48 16c-16.8 5.6-25.8 23.7-20.2 40.5s23.7 25.8 40.5 20.2l5.9-2V400H384c-17.7 0-32 14.3-32 32s14.3 32 32 32h64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32H496V304c0-10.3-4.9-19.9-13.3-26z" />
    </Icon>
  );
}
